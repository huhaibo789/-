...
import com.example.chengduhome.WrongdaskActivity;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    private void setlistener() {
        ...
        wrong_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                 Intent intent=new Intent(CaptureActivity.this,WrongdaskActivity.class);
    ...
    private void displayFrameworkBugMessageAndExit() {
        ...
        builder.setMessage("请到【设置】-【权限管理】-给予【该app】拍照权限");
